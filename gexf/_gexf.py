...
class Graph :
    ...
    def addEdge(self,id,source,target,weight="",start="",end="",label="", spells=[]) :
        self._edges[id]=Edge(self,id,source,target,weight,start,end,label, spells=spells)
...
class Edge :
    ...
    def __init__(self,graph,id,source,target,weight="",start="",end="",label="",r="",g="",b="", spells=[]) : 
    ...
    def getXML(self) :
        ...
        try :
            ...
            if self.spells:
                spells = etree.SubElement(edgeXML, "spells")
                for s, f in self.spells:
                    if s and f:
                        etree.SubElement(spells, "spell", start=s, end=f)
                    elif s and not f:
                        etree.SubElement(spells, "spell", start=s)
                    elif not s and f:
                        etree.SubElement(spells, "spell", end=f)
